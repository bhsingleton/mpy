...
class SplineIKChainControlMixin(dependencymixin.DependencyMixin):
    """
    Overload of `DependencyMixin` that interfaces with spline ik-chain controllers.
    """
    ...
    startTwistAngle = mpyattribute.MPyAttribute('startTwistAngle')
    endTwistAngle = mpyattribute.MPyAttribute('endTwistAngle')
    useUpNode = mpyattribute.MPyAttribute('useUpNode')
    # endregion
